<template>
  <div class="tab-container sell-tab">
    <div class="selects">
      <Select
    ...
    <div class="results">
      <div class="row">
        ...
        <span class="value">4,613.4 {{getOptionByValue(currencies.fiat, cryptoCurrentOption2Value).abb}}</span>
      </div>
      <div class="row">
